...
abstract class Employ implements Serializable{
...
class EmployManagementWithSerialization {
    ...
    public static void main(String[] args) {
        ...
        TreeMap<Integer, Employ> deserializedMap = new TreeMap<Integer, Employ>();
        ...
        try (RandomAccessFile raf = new RandomAccessFile("employees.csv", "r")) {
            ...
            while ((record = raf.readLine()) != null) {
                ...
                if (tempDesignation.equals("Clerk")) {
                    tempEmploy = new Clerk(tempId, tempName, tempAge, tempSalary);
                } else if (tempDesignation.equals("Programmer")) {
        ...
        try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream("employees.ser"))) {
            deserializedMap = (TreeMap<Integer, Employ>) ois.readObject();
            System.out.println("Deserialized TreeMap Successfully ");
                ...
                switch (choice) {
                    ...
                    case 2 -> {
                        ...
                        if (sortChoice == 1) {
                            ...
                            System.out.println("Now deserialized map");
                            for (Object key : deserializedMap.keySet()) {
                                Employ tempEmploy = (Employ) employMap.get(key);
                                tempEmploy.display();
                                System.out.println("----------------------");
                            }
